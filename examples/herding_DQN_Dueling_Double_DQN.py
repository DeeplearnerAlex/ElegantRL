...
0  2.01e+05     804 |  239.34   64.5    301   214 |    0.05   0.44   3.35
    """
def train_dqn_for_herding_vec_env(agent_class, gpu_id: int):
    assert agent_class in AgentClassList
    ...
    get_gym_env_args(env=gym.make('Herding-v0'), if_print=True)  # return env_args
...
if __name__ == '__main__':
    ...
    elif ENV_ID in {'4', 'herding_vec'}:
        train_dqn_for_herding_vec_env(agent_class=AgentClass, gpu_id=GPU_ID)
    else:
